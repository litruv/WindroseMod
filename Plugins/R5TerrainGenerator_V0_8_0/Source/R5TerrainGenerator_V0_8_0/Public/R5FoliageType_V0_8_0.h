...
#include "ER5AlignDirection_V0_8_0.h"
#include "ER5EnvironmentZone_V0_8_0.h"
#include "ER5ExtrusionShape_V0_8_0.h"
#include "ER5FlatnessShape_V0_8_0.h"
#include "ER5PlacementMode_V0_8_0.h"
#include "R5FoliageType_V0_8_0.generated.h"

class UR5FoliageType_V0_8_0;

UCLASS(Blueprintable)
class R5TERRAINGENERATOR_V0_8_0_API UR5FoliageType_V0_8_0 : public UObject {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5EnvironmentZone_V0_8_0 EnvironmentZone;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5AlignDirection_V0_8_0 AlignDirection;
    ...
    UPROPERTY(EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<UR5FoliageType_V0_8_0*, FFloatInterval> UndergrowthObjects;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5PlacementMode_V0_8_0 PlacementMode;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bFlatness;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5FlatnessShape_V0_8_0 FlatnessShape;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5ExtrusionShape_V0_8_0 ExtrusionShape;
