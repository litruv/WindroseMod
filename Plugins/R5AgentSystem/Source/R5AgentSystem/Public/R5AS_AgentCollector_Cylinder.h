...
#include "R5AS_AgentCollector_Cylinder.generated.h"

class AActor;

UCLASS(Blueprintable, EditInlineNew)
class R5AGENTSYSTEM_API UR5AS_AgentCollector_Cylinder : public UR5AS_AgentCollector_Base {
    GENERATED_BODY()
public:
public:
