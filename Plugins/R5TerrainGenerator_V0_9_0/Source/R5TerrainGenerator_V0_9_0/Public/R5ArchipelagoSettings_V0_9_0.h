...
#include "R5ForceDirectedEdge_V0_9_0.h"
#include "R5ForceDirectedNode_V0_9_0.h"
#include "R5ArchipelagoSettings_V0_9_0.generated.h"

UCLASS(Blueprintable)
class R5TERRAINGENERATOR_V0_9_0_API UR5ArchipelagoSettings_V0_9_0 : public UObject {
    GENERATED_BODY()
public:
    ...
    TArray<FR5ForceDirectedNode_V0_9_0> Nodes;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, EditFixedSize, meta=(AllowPrivateAccess=true))
    TArray<FR5ForceDirectedEdge_V0_9_0> Edges;
