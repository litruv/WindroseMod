...
#include "R5BLActor_Drop_EraseRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLActor_Drop_EraseRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLActor_Drop_EraseRule();
