...
#include "R5BLChest_CreatePosthumousContainer.generated.h"

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLChest_CreatePosthumousContainer {
    GENERATED_BODY()
public:
    ...
    FR5BLChest_CreatePosthumousContainer();
};
