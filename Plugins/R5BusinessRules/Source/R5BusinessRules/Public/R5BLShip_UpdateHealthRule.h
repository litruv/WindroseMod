...
#include "R5BLShip_UpdateHealthRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLShip_UpdateHealthRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLShip_UpdateHealthRule();
