...
#include "R5BLAccount_RecreateRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLAccount_RecreateRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLAccount_RecreateRule();
