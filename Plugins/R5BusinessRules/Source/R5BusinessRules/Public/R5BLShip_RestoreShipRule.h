...
#include "R5BLShip_RestoreShipRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLShip_RestoreShipRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLShip_RestoreShipRule();
