...
#include "R5BLActor_ExplodingBarrel.generated.h"

class AActor;

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLActor_ExplodingBarrel : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
