...
#include "R5BLInventory_ActionMoveItems.generated.h"

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLInventory_ActionMoveItems {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLRecordPath> FromSlotsPaths;
    ...
    FR5BLInventory_ActionMoveItems();
};
