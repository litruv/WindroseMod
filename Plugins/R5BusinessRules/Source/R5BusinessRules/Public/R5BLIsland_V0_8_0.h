...
#include "R5BLTerrainPatch_V0_8_0.h"
#include "R5BLTerrain_V0_8_0.h"
#include "R5BLIsland_V0_8_0.generated.h"

class UR5BLCommonIsland;

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLIsland_V0_8_0 : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLTerrainPatch_V0_8_0 LastTerrainPatch;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLTerrain_V0_8_0> Terrains;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLScenarioSave_V0_8_0 ScenarioSave;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLLootMetaData_V0_8_0 LootTableMetaData;
