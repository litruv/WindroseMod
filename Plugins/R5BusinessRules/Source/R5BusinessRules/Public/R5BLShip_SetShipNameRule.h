...
#include "R5BLShip_SetShipNameRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLShip_SetShipNameRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLShip_SetShipNameRule();
