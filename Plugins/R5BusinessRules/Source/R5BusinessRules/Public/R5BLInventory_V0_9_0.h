...
#include "R5BLInventoryModule_V0_9_0.h"
#include "R5BLInventory_V0_9_0.generated.h"

class UR5BLInventoryParams;

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLInventory_V0_9_0 {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLInventoryModule_V0_9_0> Modules;
