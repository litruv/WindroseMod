...
#include "R5BLInventory_AddTraitsToInventory.generated.h"

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLInventory_AddTraitsToInventory {
    GENERATED_BODY()
public:
    ...
    FR5BLInventory_AddTraitsToInventory();
};
