...
#include "R5BLShip_HireMembersRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLShip_HireMembersRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLShip_HireMembersRule();
