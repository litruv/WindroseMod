...
#include "R5BLPlayerMetadata_SaveCustomizationRuleModel.generated.h"

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLPlayerMetadata_SaveCustomizationRuleModel {
    GENERATED_BODY()
public:
    ...
    FR5BLPlayerMetadata_SaveCustomizationRuleModel();
};
