...
#include "R5BLBuilding_RegisterRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLBuilding_RegisterRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLBuilding_RegisterRule();
