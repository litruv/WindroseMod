...
#include "R5BLCraftRecipeData_V0_9_0.generated.h"

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLCraftRecipeData_V0_9_0 {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLItemsStackData_V0_9_0 OptionalItemToModify;
    
    FR5BLCraftRecipeData_V0_9_0();
};
