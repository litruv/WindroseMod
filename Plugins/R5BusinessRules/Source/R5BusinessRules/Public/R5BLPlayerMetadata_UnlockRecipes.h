...
#include "R5BLPlayerMetadata_UnlockRecipes.generated.h"

class UR5BLRecipeData;

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLPlayerMetadata_UnlockRecipes {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLRecordPath PlayerPath;
    
    FR5BLPlayerMetadata_UnlockRecipes();
};
