...
#include "R5BLPersonalInventory_V0_9_0.h"
#include "R5BLPersonalInventories_V0_9_0.generated.h"

class UR5BLInventoryParams;

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLPersonalInventories_V0_9_0 {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLPersonalInventory_V0_9_0> PersonalInventories;
    ...
    FR5BLPersonalInventories_V0_9_0();
};
