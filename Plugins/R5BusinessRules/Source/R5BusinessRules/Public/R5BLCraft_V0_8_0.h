...
#include "R5BLCraftQueueNode_V0_8_0.h"
#include "R5BLRecipe_V0_8_0.h"
#include "R5BLCraft_V0_8_0.generated.h"

class UR5BLCraftParams;

USTRUCT(BlueprintType)
struct R5BUSINESSRULES_API FR5BLCraft_V0_8_0 {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLCraftQueueNode_V0_8_0> CraftQueue;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLRecipe_V0_8_0> LastCraftedRecipeQueue;
