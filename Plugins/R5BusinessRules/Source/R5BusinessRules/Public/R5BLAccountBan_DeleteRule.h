...
#include "R5BLAccountBan_DeleteRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLAccountBan_DeleteRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLAccountBan_DeleteRule();
