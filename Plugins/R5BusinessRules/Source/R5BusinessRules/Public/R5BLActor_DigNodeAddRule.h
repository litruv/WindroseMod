...
#include "R5BLActor_DigNodeAddRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLActor_DigNodeAddRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLActor_DigNodeAddRule();
