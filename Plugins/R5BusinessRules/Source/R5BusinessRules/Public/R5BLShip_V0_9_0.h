...
#include "R5BLShipAttributes_V0_9_0.h"
#include "R5BLShipVisualArmorDamage_V0_9_0.h"
#include "R5BLShip_V0_9_0.generated.h"

class UR5BLShipParams;

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLShip_V0_9_0 : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FR5BLShipVisualArmorDamage_V0_9_0> VisualArmorDamages;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    int32 ProhibitUseUntilTime;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLShipAttributes_V0_9_0 Attributes;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BLEntityProgression_V0_9_0 Progression;
