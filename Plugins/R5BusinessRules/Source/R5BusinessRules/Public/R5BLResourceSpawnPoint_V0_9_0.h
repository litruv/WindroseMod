...
#include "R5BLResourceSpawnPoint_V0_9_0.generated.h"

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLResourceSpawnPoint_V0_9_0 : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
    ...
    UR5BLResourceSpawnPoint_V0_9_0();
