...
#include "R5BLFarming_PlantCropRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLFarming_PlantCropRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLFarming_PlantCropRule();
