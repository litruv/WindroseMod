...
#include "R5BLAccount_AttachPlayers.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLAccount_AttachPlayers : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLAccount_AttachPlayers();
