...
#include "R5BLDynamicGenericActor_V0_8_0.generated.h"

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLDynamicGenericActor_V0_8_0 : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
    ...
    UR5BLDynamicGenericActor_V0_8_0();
