...
#include "R5BLTerrainPatch_AddRule.generated.h"

UCLASS(Blueprintable)
class R5BUSINESSRULES_API UR5BLTerrainPatch_AddRule : public UR5BLBusinessRuleBaseUe {
    GENERATED_BODY()
public:
    UR5BLTerrainPatch_AddRule();
