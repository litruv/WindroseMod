...
#include "R5BLActor_DigVolume_V0_9_0.generated.h"

UCLASS(Blueprintable, NonTransient)
class R5BUSINESSRULES_API UR5BLActor_DigVolume_V0_9_0 : public UR5BLVersionedRecord {
    GENERATED_BODY()
public:
