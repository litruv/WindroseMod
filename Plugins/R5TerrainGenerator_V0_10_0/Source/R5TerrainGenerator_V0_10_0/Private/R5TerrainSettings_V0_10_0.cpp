#include "R5TerrainSettings_V0_10_0.h"

UR5TerrainSettings_V0_10_0::UR5TerrainSettings_V0_10_0() {
    ...
    this->PreviewLayer = ER5TGPreviewLayer_V0_10_0::EPL_Heatmap;
    this->bExportHeightmap = true;
    this->bExportWeightmaps = true;
    this->LandscapeMaterialPermutationHash = 0;
}

TArray<FName> UR5TerrainSettings_V0_10_0::GetLayerOptions() {
    return TArray<FName>();
}
