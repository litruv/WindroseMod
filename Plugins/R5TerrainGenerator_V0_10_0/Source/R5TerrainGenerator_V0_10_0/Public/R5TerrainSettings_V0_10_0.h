...
#include "ER5TGPreviewLayer_V0_10_0.h"
#include "R5BiomeGrid_V0_10_0.h"
#include "R5HydraulicErosionSettings_V0_10_0.h"
#include "R5ManualPlacedObject_V0_10_0.h"
#include "R5ScaRuleWrapper_V0_10_0.h"
#include "R5TerrainSettings_V0_10_0.generated.h"

class ULandscapeGrassType;
class ULandscapeLayerInfoObject;
class UMaterialInstanceConstant;
class UMaterialInterface;
class UR5BiomeSettings_V0_10_0;

UCLASS(Blueprintable)
class R5TERRAINGENERATOR_V0_10_0_API UR5TerrainSettings_V0_10_0 : public UObject {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<UR5BiomeSettings_V0_10_0*> BiomeList;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<FIntPoint, float> BiomeBlendLUT;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5BiomeGrid_V0_10_0 BiomeGridData;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<FName, FR5ScaRuleWrapper_V0_10_0> PhaseRules;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ER5TGPreviewLayer_V0_10_0 PreviewLayer;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FName PreviewLayerName;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FR5HydraulicErosionSettings_V0_10_0 HydraulicErosion;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<FVector2D, FR5ManualPlacedObject_V0_10_0> ManualPlacedObjects;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FGameplayTag WeatherTag;
    
    UR5TerrainSettings_V0_10_0();
