...
//CROSS-MODULE INCLUDE V2: -ModuleName=AIModule -ObjectName=EEnvQueryTrace -FallbackName=EEnvQueryTrace
...
#include "R5EnvTraceData.generated.h"

USTRUCT(BlueprintType)
struct R5EQS_API FR5EnvTraceData {
    GENERATED_BODY()
public:
