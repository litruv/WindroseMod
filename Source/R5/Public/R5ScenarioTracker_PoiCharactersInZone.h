...
#include "R5ScenarioTracker_PoiCharactersInZone.generated.h"

class AActor;
class UPrimitiveComponent;
class UR5ScenarioNode;
class UR5ScenarioTracker_PoiCharactersInZone;
class UShapeComponent;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTracker_PoiCharactersInZone : public UR5ScenarioTrackerRegular {
    GENERATED_BODY()
public:
...
public:
    UR5ScenarioTracker_PoiCharactersInZone();
...
public:
    UFUNCTION(BlueprintCallable)
    static UR5ScenarioTracker_PoiCharactersInZone* CreateTracker(ER5ScenarioBlackboardType Blackboard, bool SaveToPersistent, UR5ScenarioNode* Owner, FGameplayTagContainer CharacterTags, FGameplayTag WriteToBlackboardAs, FGameplayTagContainer PoiOverlapZones);
