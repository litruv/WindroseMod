...
#include "R5ScenarioListener_PoiCustomActorEvent.generated.h"

class AActor;

UCLASS(Blueprintable)
class R5_API UR5ScenarioListener_PoiCustomActorEvent : public UR5ScenarioGraphNodeListener {
    GENERATED_BODY()
public:
    ...
    UR5ScenarioListener_PoiCustomActorEvent();
