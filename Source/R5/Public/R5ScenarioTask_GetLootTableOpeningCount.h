...
#include "R5ScenarioTask_GetLootTableOpeningCount.generated.h"

class UR5BLLootParams;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_GetLootTableOpeningCount : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
public:
...
public:
    UR5ScenarioTask_GetLootTableOpeningCount();
