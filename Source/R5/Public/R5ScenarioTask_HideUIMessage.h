...
#include "R5ScenarioTask_HideUIMessage.generated.h"

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_HideUIMessage : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
public:
