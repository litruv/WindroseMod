...
#include "R5ScenarioTask_MarkQuestAsUpdated.generated.h"

class UR5BLQuestParams;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_MarkQuestAsUpdated : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
public:
...
public:
    UR5ScenarioTask_MarkQuestAsUpdated();
