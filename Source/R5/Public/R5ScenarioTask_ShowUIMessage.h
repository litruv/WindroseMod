...
#include "R5ScenarioTask_ShowUIMessage.generated.h"

class UTexture2D;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_ShowUIMessage : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
public:
