...
#include "R5AS_TargetSelector_PriorityForTargetsInBM.generated.h"

UCLASS(Blueprintable, EditInlineNew)
class R5_API UR5AS_TargetSelector_PriorityForTargetsInBM : public UR5AS_TargetSelector_Base {
    GENERATED_BODY()
public:
public:
...
public:
    UR5AS_TargetSelector_PriorityForTargetsInBM();
