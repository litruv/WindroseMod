...
#include "R5Ability.h"
#include "R5StackConsumptionDamageAbility.generated.h"

class AActor;
class UR5StackConsumptionDamageAbilityParams;

UCLASS(Blueprintable)
class R5_API UR5StackConsumptionDamageAbility : public UR5Ability {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UR5StackConsumptionDamageAbilityParams* Params;
    
    UR5StackConsumptionDamageAbility();
