...
#include "R5ScenarioTask_GetRewardByLootTable.generated.h"

class UR5BLLootParams;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_GetRewardByLootTable : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
public:
...
public:
    UR5ScenarioTask_GetRewardByLootTable();
