...
#include "R5ScenarioListener_WaitEvent.generated.h"

UCLASS(Blueprintable)
class R5_API UR5ScenarioListener_WaitEvent : public UR5ScenarioGraphNodeListener {
    GENERATED_BODY()
public:
public:
