...
#include "R5AS_Categorizer_IsShipPassenger.generated.h"

UCLASS(Blueprintable, EditInlineNew)
class R5_API UR5AS_Categorizer_IsShipPassenger : public UR5AS_Categorizer_Base {
    GENERATED_BODY()
public:
public:
...
public:
    UR5AS_Categorizer_IsShipPassenger();
