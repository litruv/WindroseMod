...
#include "R5ScenarioTask_PoiDespawnAICharacter.generated.h"

class AR5AICharacter;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTask_PoiDespawnAICharacter : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
    ...
    UR5ScenarioTask_PoiDespawnAICharacter();
