...
#include "R5GATD_PreExecutionShipEffectData.generated.h"

USTRUCT(BlueprintType)
struct R5_API FR5GATD_PreExecutionShipEffectData : public FGameplayAbilityTargetData {
    GENERATED_BODY()
public:
    ...
    FR5GATD_PreExecutionShipEffectData();
};
