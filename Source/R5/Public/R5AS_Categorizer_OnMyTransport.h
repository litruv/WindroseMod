...
#include "R5AS_Categorizer_OnMyTransport.generated.h"

UCLASS(Blueprintable, EditInlineNew)
class R5_API UR5AS_Categorizer_OnMyTransport : public UR5AS_Categorizer_Base {
    GENERATED_BODY()
public:
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bSkipIfOwnerNotOnTransport;
    
public:
    UR5AS_Categorizer_OnMyTransport();
