...
#include "R5StateTreeCompareDistanceCondition.generated.h"

USTRUCT(BlueprintType)
struct R5_API FR5StateTreeCompareDistanceCondition : public FStateTreeConditionCommonBase {
    GENERATED_BODY()
public:
    ...
    FR5StateTreeCompareDistanceCondition();
};
