...
#include "R5ScenarioTask_PoiSpawnAICharacterWithEQS.generated.h"
...
class R5_API UR5ScenarioTask_PoiSpawnAICharacterWithEQS : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
    ...
    UR5ScenarioTask_PoiSpawnAICharacterWithEQS();
