...
#include "R5STT_HasRangeAttackCapacityInBattleManager_InstanceData.generated.h"

USTRUCT(BlueprintType)
struct R5_API FR5STT_HasRangeAttackCapacityInBattleManager_InstanceData {
    GENERATED_BODY()
public:
    ...
    FR5STT_HasRangeAttackCapacityInBattleManager_InstanceData();
};
