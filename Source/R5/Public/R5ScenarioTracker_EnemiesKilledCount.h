...
#include "R5ScenarioTracker_EnemiesKilledCount.generated.h"

class APawn;
class UR5ScenarioNode;

UCLASS(Blueprintable)
class R5_API UR5ScenarioTracker_EnemiesKilledCount : public UR5ScenarioTracker {
    GENERATED_BODY()
public:
    UR5ScenarioTracker_EnemiesKilledCount();
...
public:
    UFUNCTION(BlueprintCallable)
    static UR5ScenarioTracker* CreateTracker(ER5ScenarioBlackboardType Blackboard, bool SaveToPersistent, UR5ScenarioNode* Owner, TSubclassOf<APawn> EnemyClass, FGameplayTag KillCounterTag, bool AllowRegisterChildClasses);
