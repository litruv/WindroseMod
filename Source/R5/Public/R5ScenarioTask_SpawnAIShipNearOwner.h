...
#include "R5ScenarioTask_SpawnAIShipNearOwner.generated.h"
...
class R5_API UR5ScenarioTask_SpawnAIShipNearOwner : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
    ...
    UR5ScenarioTask_SpawnAIShipNearOwner();
