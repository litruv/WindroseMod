...
#include "R5STT_HasMeleeAttackCapacityInBattleManager_InstanceData.generated.h"

USTRUCT(BlueprintType)
struct R5_API FR5STT_HasMeleeAttackCapacityInBattleManager_InstanceData {
    GENERATED_BODY()
public:
    ...
    FR5STT_HasMeleeAttackCapacityInBattleManager_InstanceData();
};
