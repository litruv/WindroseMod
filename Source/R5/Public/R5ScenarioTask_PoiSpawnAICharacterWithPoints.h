...
#include "R5ScenarioTask_PoiSpawnAICharacterWithPoints.generated.h"
...
class R5_API UR5ScenarioTask_PoiSpawnAICharacterWithPoints : public UR5ScenarioGraphNodeTask {
    GENERATED_BODY()
public:
    ...
    UR5ScenarioTask_PoiSpawnAICharacterWithPoints();
